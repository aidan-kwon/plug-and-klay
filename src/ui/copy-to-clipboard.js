...
export default function CopyToClipboard (getContent, tip = 'Copy value to clipboard', icon = 'fa-copy') {
  return <i title={tip} className={`${css.copyIcon} far ${icon} p-2`} data-id="copyToClipboardCopyIcon"
