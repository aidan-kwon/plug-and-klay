...
import {
  dismissPopup as dismissAction,
  displayPopup as displayAction
      ...
      <div className={`${css.instanceContainer} border-0 list-group-item`}>
        ...
        </div>
        {
          this.state.contracts.map(contract => {
            ...
            return <UniversalDAppUI key={ contract.created } abi={ contract.abi } address={ contract.address } created={ contract.created } contractName={ contract.name } blockchain={ this.props.blockchain } />
          })
        }
        {
